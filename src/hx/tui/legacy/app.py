...
from hx.tui.legacy.commands import CommandContext, CommandRegistry, build_default_commands
from hx.tui.legacy.widgets.autocomplete import Autocomplete
from hx.tui.legacy.widgets.frame import BottomRule, PromptFrame
...
from hx.tui.legacy.widgets.todos import SubagentRows, TodoSidebar
...
class HXApp(App[None]):
    ...
    async def on_mount(self) -> None:
        ...
        if not self.settings.quiet_startup:
            ...
            from hx.tui.legacy.widgets.header import StartupHeader
    ...
    async def _open_command_palette(self) -> None:
        from hx.tui.legacy.widgets.palette import CommandPalette
